...
class OnboardingPage4 extends StatefulWidget {
  ...
  @override
  State<OnboardingPage4> createState() => _OnboardingPage2State();
}

class _OnboardingPage2State extends State<OnboardingPage4> {
      ...
      body: Stack(
        ...
        children: [
          ...
          Positioned(
            ...
            child: AnimatedCard(
              showCard: _showCard,
              imagePath: Assets.message5_onboarding,
              width:width*0.9,
              height: height*0.45,
